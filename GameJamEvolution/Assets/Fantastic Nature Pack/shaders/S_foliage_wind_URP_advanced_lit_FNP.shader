...
Shader "TidalFlask/Foliage Wind URP Advanced Lit FNP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float3 temp_output_411_0 = ( saturate( ( ( bakedGI75 + clampResult116 ) * ase_lightColor.rgb ) ) + localAdditionalLightsFlat12x118_g1 );
...
ASEEND*/
//CHKSM=A42FCE2E3C3B2DA5DC5CD2C6B1CEF3EE9F860B8A